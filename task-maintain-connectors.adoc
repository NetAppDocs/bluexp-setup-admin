...
BlueXP notifies you when the Connector VM's disk space is low. Monitor these notifications in the Notifications Center or configure it to send email alerts. Resolving disk space issues is your responsibility. 
