...
=== Unified control of your storage from the BlueXP canvas
...
BlueXP includes a comprehensive suite of integrated data services, including data protection, replication, cyber resilience, and data lifecycle management. These services help you maintain the security, integrity, and availability of your data across your on-premises and cloud storage environments.
