...
On the BlueXP canvas, _working environments_ represent the cloud or on-premises storage that you've discovered or deployed. You can select a working environment and integrate it with BlueXP data services or enter the working environment to complete storage management actions like adding volumes.
