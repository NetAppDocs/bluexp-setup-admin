...
[role="quick-margin-para"]
Note that if you want to use NetApp Intelligent Services to manage storage and data in Google Cloud, then the Connector must be running in Google Cloud.
