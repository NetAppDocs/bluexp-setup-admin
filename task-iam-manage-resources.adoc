...
* <<view-folders-and-projects,View the associated folders and projects>>
* <<associate-resource,Associate the resource with folders and projects>>
...
The following examples shows a resource that is associated with one project.
