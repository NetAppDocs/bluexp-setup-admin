...
BlueXP automatically discovers information about resources that are associated with your organization and displays them in the *Resources* page as undiscovered resources. If there are any undiscovered resources, you can discover them from the BlueXP canvas as working environments. After you discover the resources, your organization's members can them from the BlueXP canvas.
...
The *Discovered in BlueXP* column identifies whether you have any resources that haven't been discovered in BlueXP yet.
