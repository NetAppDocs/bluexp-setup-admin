...
You can view both discovered and undiscovered resources that are associated with your organization. Undiscovered resources are typically storage resources known through digital advisor that you have not yet discovered. 
