...
[NOTE]
====
* At this time, notifications are sent by email for the following BlueXP features and services: the Connector, BlueXP digital wallet, BlueXP copy and sync, and BlueXP backup and recovery.
