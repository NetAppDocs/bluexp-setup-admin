...
[NOTE]
====
* Notifications are sent by email for the following features and services: the Connector, digital wallet, copy and sync, and backup and recovery.
...
You must be a have the Organization admin role to customize the notifications settings.
