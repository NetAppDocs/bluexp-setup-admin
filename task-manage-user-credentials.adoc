...
When using a Connector, BlueXP does not prompt users to enter their ONTAP credentials. For advanced management (access to ONTAP System Manager), your BlueXP administrator may configure BlueXP to prompt you enter your ONTAP credentials to ensure you have the right permissions to manage your ONTAP clusters. When this setting is enabled, you need to enter your ONTAP credentials and they are not stored by BlueXP.
