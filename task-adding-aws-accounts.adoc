...
----
+
Refer to link:https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies-cross-account-resource-access.html[AWS Identity and Access Management documentation^] for more information on creating roles and trust relationships.
