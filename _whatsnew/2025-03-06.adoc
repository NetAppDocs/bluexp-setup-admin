...
This feature is available in Connector version 3.9.49 and higher. link:https://docs.netappl.com/task-ontap-access-connector.html[Learn how to configure credentials settings.^].
