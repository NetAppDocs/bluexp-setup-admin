...
| Connector | 3.9.50, 3.9.49 | Gto to the https://docs.netapp.com/us-en/bluexp-setup-admin/whats-new.html#connector-3-9-50[what's new in BlueXP connector page] and refer to the changes included for versions 3.9.50 and 3.9.49.
