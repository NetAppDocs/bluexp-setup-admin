...
== Operating system for the Connector

The operating system for the Connector is determined by the BlueXP deployment mode and installation method.
...
link:task-upgrade-connector.html[Learn how to manually upgrade the Connector software].
