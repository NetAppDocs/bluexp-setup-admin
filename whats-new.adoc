...
==== Azure permissions update

We updated the Connector policy for Azure to include the following permissions:
...
These permissions are required for Cloud Volumes ONTAP support of Virtual Machine Scale Sets.

* https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/whats-new.html[Learn about Cloud Volumes ONTAP support for Virtual Machine Scale Sets^]
