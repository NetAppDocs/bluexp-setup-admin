...
=== Amazon EC2 Instance Metadata Service requirement

You should be aware that IMDSv1 is required on EC2 instances before you manually install the Connector software in AWS.
