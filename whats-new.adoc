...
This release includes an enhancement to SSL certificates and bug fixes.
...
* The Certificate Subject Alternative Name is the Fully Qualified Domain Name (FQDN) of the host machine (mentioned in NewCertificate2.png)
