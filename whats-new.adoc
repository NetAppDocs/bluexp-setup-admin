...
The Connector is now supported on hosts running the following versions of Red Hat Enterprise Linux with _new_ Connector installations:
...
You should be aware of Podman requirements, a known limitation, a summary of operating system support, what to do if you have a RHEL 7 host, how to get started, and more.

link:reference-connector-new-operating-system-support.html[RHEL 8 and 9 support for the Connector]
