...
+
If you want to run your existing Connector on a RHEL 8 or 9 host, you need to set up a _new_ RHEL 8 or 9 host and install Podman. You can then perform a new Connector installation and configure it to discover the working environments that the old Connector was managing.
