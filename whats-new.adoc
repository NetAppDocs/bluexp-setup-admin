...
This release includes enhancements, minor security improvements, and bug fixes.

The enhancements include the following:

* The ability to edit your name in *User Settings*.
+
...
+
https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/whats-new.html#7-february-2024[Learn about Cloud Volumes ONTAP enhancements^]
