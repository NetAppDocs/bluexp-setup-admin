...
Starting with the 3.9.45 release, BlueXP now supports installing the Connector on an Ubuntu 22.04 LTS host when using BlueXP in standard mode or restricted mode.
...
Starting with the 3.9.45 release, BlueXP now supports the Connector with Red Hat Enterprise Linux hosts that have SELinux enabled in either enforcing mode or permissive mode.
