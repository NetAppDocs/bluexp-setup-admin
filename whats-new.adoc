...
This release includes support for installing the Connector on a Red Hat Enterprise Linux 8 or 9 host when using private mode. The following versions are supported:
