...
This release includes minor security improvements and bug fixes. At this time, the 3.9.37 release is available for standard mode and restricted mode.

=== Edit name

If you NetApp cloud credentials to log in to BlueXP, you can now edit your name in *User Settings*.

image:screenshot-edit-name.png[A screenshot that shows the ability to edit your name under User Settings.]

Editing your name is not supported if you log in with a federated connection or your NetApp Support Site account.
