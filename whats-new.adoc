...
+ 
If you have an existing Connector running on RHEL 7, we don't support upgrading the operating system to RHEL 8 or 9.
+
If you need to run your existing Connector on a RHEL 8 or 9 host instead, then you need to set up a _new_ RHEL 8 or 9 host and install Podman. You can then perform a new Connector installation and configure it to discover the working environments that the old Connector was managing.
