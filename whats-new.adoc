...
A new private mode release is now available for BlueXP. This release includes version 3.9.38 of the Connector and versions of the BlueXP services that are supported with private mode as of March 2024.
