...
BlueXP now supports the Amazon EC2 Instance Metadata Service (IMDSv2) with the Connector instance and with Cloud Volumes ONTAP instances. Only IMDSv1 was previously supported.
...
https://docs.netapp.com/us-en/bluexp-setup-admin/task-managing-connectors.html[Learn how to configure IMDSv2 on existing instances].
