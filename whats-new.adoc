...
* This release of the Connector also includes Cloud Volumes ONTAP enhancements and on-premisesONTAP cluster enhancements.
+
...
** https://docs.netapp.com/us-en/bluexp-ontap-onprem/whats-new.html#30-july-2023[Learn about ONTAP on-premisescluster enhancements^]
...
** https://docs.netapp.com/us-en/bluexp-ontap-onprem/whats-new.html#3-april-2023[Learn about ONTAP on-premisescluster enhancements^]
...
** https://docs.netapp.com/us-en/bluexp-ontap-onprem/whats-new.html#4-december-2022[Learn about ONTAP on-premisescluster enhancements^]
...
+
You can use BlueXP to create and administer cloud storage (for example, Cloud Volumes ONTAP and Azure NetApp Files), to move, protect, and analyze data, and to control many on-premisesand edge storage devices.
+
...
+
image:https://raw.githubusercontent.com/NetAppDocs/bluexp-setup-admin/main/media/screenshot-navigation-menu.png[A screenshot of the navigation menu in BlueXP that shows categories such as Storage and Health.]

New product integrations::
* You can now manage the Amazon S3 buckets in the AWS accounts where the Connector is installed.
* You can now manage more on-premisesstorage systems, such as E-Series and StorageGRID. 
...
** https://docs.netapp.com/us-en/bluexp-ontap-onprem/whats-new.html#7-june-2022[Learn about ONTAP on-premisescluster enhancements^]
...
image:https://raw.githubusercontent.com/NetAppDocs/bluexp-setup-admin/main/media/screenshot_nss_management.png[A screenshot of the NSS Management tab in the Support Dashboard where you can add NSS accounts.]
...
link:task-monitor-cm-operations.html[Learn how to filter the Timeline to the Tenancy service].
...
* Cloud Tiering now displays if you have any undiscovered on-premisesONTAP clusters so that you can add them to Cloud Manager to enable tiering or other services on those clusters.
+
