...
A new private mode release is now available for BlueXP. This release includes version 3.9.35 of the Connector and versions of the BlueXP services supported with private mode as of October 2023. 
...
* https://docs.netapp.com/us-en/bluexp-setup-admin/task-quick-start-private-mode.html[Learn how to get started with private mode]
