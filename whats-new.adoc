...
=== New CPU and RAM requirements

To improve the performance of BlueXP and the Connector, we now require additional CPU and RAM for the Connector virtual machine:

* *CPU*: 5 cores or 5 vCPUs (the previous requirement was 4 vCPUs)
* *RAM*: 18 GB (the previous requirement was 14 GB)
