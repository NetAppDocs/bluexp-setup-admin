...
There are no changes to your existing users or working environments. No conversion or migration is required. When you log in, you'll notice these changes:
...
This change does introduce a new API for BlueXP IAM, but it is backwards compatible with the previous tenancy API. Learn about the API for BlueXP IAM. !!! link to be added !!!
