...
These permissions are required for an upcoming Cloud Volumes ONTAP release. The Cloud Volumes ONTAP release notes will include more details when that release is available.
