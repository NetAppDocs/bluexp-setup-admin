...
This release of the BlueXP Connector includes minor improvements, bug fixes, and support for a new version of Red Hat Enterprise Linux.

At this time, the 3.9.43 release is available for standard mode and restricted mode.

==== Support for RHEL 8.10

This release includes support for installing the Connector on a Red Hat Enterprise Linux 8.10 host when using standard mode or restricted mode.
