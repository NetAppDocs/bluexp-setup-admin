...
This section lists support for storage discovery and management from the BlueXP canvas. This section does not cover supported backup destinations for BlueXP backup and recovery.
...
| Backup and recovery 
| Yes
https://docs.netapp.com/us-en/bluexp-backup-recovery/concept-protection-journey.html#support-for-sites-with-no-internet-connectivity[View the list of supported backup destinations for ONTAP data^]
| Yes
https://docs.netapp.com/us-en/bluexp-backup-recovery/concept-protection-journey.html#support-for-sites-with-no-internet-connectivity[View the list of supported backup destination for ONTAP data^]
