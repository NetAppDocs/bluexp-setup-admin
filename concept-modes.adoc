...
This section lists support for working environment management from the BlueXP canvas. It does not list supported backup destinations for BlueXP backup and recovery.
