...
* Back up and restore of on-prem ONTAP volumes to StorageGRID systems is supported.
+
...
* Back up and restore of on-prem ONTAP volumes to ONTAP S3 is also supported.
+
https://docs.netapp.com/us-en/bluexp-backup-recovery/task-backup-onprem-to-ontap-s3.html[Learn how to back up on-prem ONTAP data to ONTAP S3^]
