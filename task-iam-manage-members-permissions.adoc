...
You can view a list of all members in your BlueXP organization. If you need to understand which resources a member of your organization can access, you can view the folders and projects associated with that member, along with their roles.
