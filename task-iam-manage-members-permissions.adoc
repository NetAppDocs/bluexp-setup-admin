...
[.lead]
BlueXP identity and access management (IAM) enables you to associate members with your organization and provide them permissions to the resources in the entire organization or in specific folders and projects. You can associate new user accounts and service accounts, manage member roles, and more.
