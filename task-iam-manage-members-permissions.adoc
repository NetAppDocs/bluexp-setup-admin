...
<<<<<<< HEAD
Suggestion: TIP: Ensure two members have the Organization admin role to avoid losing access to your BlueXP organization.
=======
TIP: To avoid losing access to your BlueXP organization, ensure two members have the Organization admin role.
>>>>>>> 62799fb426e8132fb06ca5488250fe1960e9149c
...
<<<<<<< HEAD
You can add a service account directly from BlueXP. Users must sign up for a BlueXP account before being added to an organization or assigned a role.
=======
