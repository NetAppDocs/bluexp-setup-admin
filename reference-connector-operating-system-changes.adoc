...
BlueXP supports the Connector with the following versions of Red Hat Enterprise Linux (RHEL):

* 8.6 to 8.9
* 9.1 to 9.3

This support was introduced with the 3.9.40 release for standard mode and restricted mode, and with the 3.9.42 release for private mode. 
