...
Enabling MFA is not available to users who use single-sign on (federation) with an external identity provider or who use their NetApp Support Site credentials. If either of these are true for you, you will not see the option to enable MFA in your profile settings.
...
Recovery codes can be used only once. If you have used your recovery code or lost it, you can generate a new one.
