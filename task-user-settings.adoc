...
Do not enable MFA if your user account is for BlueXP API access, enabling multi-factor authentication will block that access. Consider using a service account for all API access. 
