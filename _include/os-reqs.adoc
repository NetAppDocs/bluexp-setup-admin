...
| Operating system
| Supported versions
| First supported Connector version
...
| 3.9.40 with BlueXP in standard mode or restricted mode

3.9.42 with BlueXP in private mode

| Podman version 4.6.1 or 4.9.4
| SELinux is supported in enforcing mode or permissive mode

.2+| Ubuntu

| 24.04 LTS
| 3.9.45 with BlueXP in standard mode or restricted mode
