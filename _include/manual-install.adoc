...
** If the password contains a special character, you need to use the ASCII code for each special character. For example, the password _NetApp#_ should be entered as _NetApp%35_
