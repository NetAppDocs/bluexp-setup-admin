...
== Application roles
Application roles provide access to BlueXP applications like AIQ Digital Advisor and Cloud Insights.
...
== Data services roles
Data services roles allow users accesscan complete their tasks in any project or folder.
