...
.Organization admin
Assign the Organization admin role only to those users who need to create new working environments or new connectors. This role has no restrictions in BlueXP and users with this role can make changes to any project or folder. 

.Folder or project admin
Use this role to delegate administrative responsibilities within your organization. The Folder or project admin role can perform most tasks in BlueXP, but only within the folder or project for which they are an admin. They are also permitted to modify and create projects, resources and folders in the folders or in which they have permission to do so.
...
| Create working environments | Yes | No 
