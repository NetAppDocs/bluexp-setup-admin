...
== Organization roles
BlueXP IAM includes two organization roles: Organization admin and Folder or Project admin. The only difference between the two BlueXP IAM organization roles is scope. The Org Admin role has the following permissions in all folders and projects; while the Folder or project admin only has the following permissions in the folder or project to which they have been assigned. 
