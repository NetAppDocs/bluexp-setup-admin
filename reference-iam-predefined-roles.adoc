...
== Organization roles
BlueXP IAM includes two organization roles: Organization admin and Folder or Project admin. The main difference between the two BlueXP IAM organization roles is scope. The Organization admin role has permissions in all folders and projects; while the Folder or project admin only has permissions in the folder or project to which they have been assigned.
...
| Create or modify working environments (add or discover new resources using the BlueXP canvas) |	Yes | Yes 

| Create projects/folders, including renaming, removing, and editing | Yes | Yes 
