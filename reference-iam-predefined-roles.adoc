...
* *Storage admin*: Administer storage health and governance functions, as well as discovery storage resources.
* *Storage viewer*: View storage health and governance functions, as well as view previously discovered storage resources.data
...
3+| *Digital advisor*
| View all pages and functions | Yes | No
| *Create Connector* | No | No 
3+| *Software updates* 
| View landing page and recommendations | Yes | No 
| Review potential version recommendations and key benefits | Yes | No 
| View update details for a cluster| Yes | Yes
| Run pre-update checks and download upgrade plan| Yes | Yes
| Install software updates | Yes | No
3+| *Operational resiliency*
| Review security risk issues | Yes | Yes
| Download Ansible playbooks | Yes | No
| Remediate issues automatically | Yes | No
3+| *Economic efficiency*
| Review capacity planning status | Yes | Yes
| Choose next action (best practice, tier) | Yes | No
| Tier cold data to cloud storage and free up storage| Yes | No
| View service requests created by any user within the Organization | Yes | Yes
| Set up reminders | Yes | Yes
| Create a connector or discover storage resource to view tech refresh | Yes | No

3+| *Sustainability*
| View dashboard and recommendations | Yes | Yes
| Download report data | Yes | Yes
| Edit carbon mitigation percentage| Yes | No
| Fix recommendations | Yes | No
| Defer recommendations | Yes | No
3+| *System manager access*
| May enter credentials | Yes | No
3+| *Credentials*
