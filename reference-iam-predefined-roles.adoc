...
| link:reference-iam-keystone-roles.html[Keystone admin^] | Users with the Keystone admin role can create service requests.

Allows users to monitor and view consumption, assets, and administrative information within the Keystone tenant they are accessing. 


| link:reference-iam-keystone-roles.html[Keystone viewer^]|	Users with the Keystone viewer role CANNOT make service requests.
