...
.Organization admin
Assign the Organization admin role sparingly. This role has no restrictions in BlueXP and users with this role can make changes to any project or folder. 

.Folder or project admin
Use this role to delegate administrative responsibilities within your organization. The Folder or project admin role can perform most tasks in BlueXP, but only within the folder or project for which they are an admin. They are permitted to modify and create projects, resources and folders only in those where they have permission to do so.

.Classification viewer
Assign the Classification viewer role to users whose tasks are related to compliance and generating reports for resources that they have permission to access. These users can't enable or disable scanning of volumes, buckets, or database schemas.
...
| Use all BlueXP services | Yes | Yes

| Add, edit, and delete folders and projects within a folder | Yes | Yes

| Add a user to a folder or project and associate a role at the project or folder level | Yes | Yes 

| Associate a connector with a folder or project | Yes | Yes 

| View, associate and disassociate resources within a folder or project | Yes | Yes 
...
| Register for BlueXP support and submit cases | Yes |	Yes 
