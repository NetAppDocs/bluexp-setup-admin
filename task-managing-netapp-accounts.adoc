...
[.lead]
When you use BlueXP in private mode, you'll use a _BlueXP account_ to manage users and organize resources. When you create your account, it only includes a single user and a workspace. You can manage the account to fit your needs by adding users, creating service accounts for automation purposes. 
