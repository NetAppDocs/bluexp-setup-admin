...
The users in your account can access and manage the resources in specific workspaces.
...
You can associate and disassociate users with workspaces at any time. Associating the user enables them to create and view the working environments in that workspace.
