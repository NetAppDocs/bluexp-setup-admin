...
You can associate a resource across different levels of your resource hierarchy: with one or more folders or with one or more projects. For example, you might associate a Cloud Volumes ONTAP system with all projects in your organization or just with a single project. How you associate a resource depends on your organization's needs.
