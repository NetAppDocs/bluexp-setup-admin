...
////
Need to add a note or paragraph here that describes what to do if you want to grant access to a project but not the folder? Assign the resource to a project to which the user has access. Resources can belong to multiple projects, but projects cannot belong to multiple folders. If you want to grant access, you'll need to re-assign the resource, not the project.
////
