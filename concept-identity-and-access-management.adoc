...
Folders can hold projects, other folders, or both.
...
When you associate a resource with a folder, it does not automatically become accessible to all projects, only the _Folder or project admin_ can see the resource. The _Folder or project admin_ decides which projects can access it and associates the resource with the appropriate projects.
