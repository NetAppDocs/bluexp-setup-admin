...
The following diagram shows an advanced example of an organization that uses folders to organize the projects for each geographic location in the business. The members include an organization admin and an admin for each folder in the organization.
