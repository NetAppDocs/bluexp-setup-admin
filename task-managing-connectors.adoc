...
* For existing Connectors, both IMDSv1 and IMDSv2 are supported.

* For Cloud Volumes ONTAP, IMDSv1 is enabled by default on new and existing instances, but IMDSv2 is also supported.
