...
.3+| Required for an upcoming Cloud Volumes ONTAP release
...
The following permissions were added to the JSON policy because they are required for an upcoming Cloud Volumes ONTAP release:
